...
public class VentanaAdmin extends JFrame implements Colores, Fonts{
	...
	public VentanaAdmin() {
		...
		panelRegistros.setBackground(COLOR_PRINCIPAL);
		panelRegistros.setBounds(0, 245, 210, 39);
		contenidoPanel.add(panelRegistros);
		panelRegistros.setLayout(new BorderLayout(0, 0));
		
		JLabel txtRegistros = new JLabel("Registrar usuario");
		txtRegistros.setForeground(COLOR_FONDO);
		txtRegistros.setFont(FUENTE_PRINCIPAL);
		txtRegistros.setHorizontalAlignment(SwingConstants.CENTER);
		panelRegistros.add(txtRegistros, BorderLayout.CENTER);
		
		JPanel panelSalir = new JPanel();
		panelSalir.setBackground(COLOR_PRINCIPAL);
		panelSalir.setBounds(0, 294, 210, 39);
		...
		panelRegistros.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				resaltar(txtRegistros, panelRegistros);
				actualizarCursor(panelRegistros);
			}
			
			public void mouseExited(MouseEvent e) {
				restaurar(txtRegistros, panelRegistros);
				resetearCursor(panelRegistros);
			}
		});
		...
		txtRegistros.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				VentanaPrinDoctor registro = new VentanaPrinDoctor();
